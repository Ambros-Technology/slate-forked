  ...
  nodes: function* nodes(root) {
    ...
    while (true) {
      ...
      if (reverse && p[p.length - 1] !== 0) {
        ...
        if (!_newPath) continue;
        p = _newPath;

        var _node3 = Node.get(root, p);
      ...
      var parent = Path.parent(p);
      if (!parent) break;
      p = parent;
      var node = Node.get(root, p);
      if (!node) break;
      n = node;
      visited.add(n);
    }
...
var Operation = {
  ...
  inverse: function inverse(op) {
    switch (op.type) {
      case 'insert_node':
        {
          return _objectSpread$d(_objectSpread$d({}, op), {}, {
            type: 'remove_node'
          });
        }
    ...
    case 'insert_node':
      {
        ...
        if (!parent) {
          return editor.onError({
            ...
            message: "Cannot apply an \"insert_node\" operation at path [".concat(path, "] because it has no parent."),
            data: {
              path: path,
              selection: selection
            },
        ...
        if (index > parent.children.length) {
          return editor.onError({
            ...
            message: "Cannot apply an \"insert_node\" operation at path [".concat(path, "] because the destination is past the end of the node."),
            data: {
              path: path,
              parent: parent,
              selection: selection
        ...
        if (selection) {
          var _iterator = _createForOfIteratorHelper$k(Range.points(selection)),
              _step;
    ...
    case 'insert_text':
      {
        ...
        if (!_node) {
          return editor.onError({
            ...
            message: "Cannot apply an \"insert_text\" operation at path [".concat(_path, "] because it could not be found."),
            data: {
              path: _path,
              selection: selection
            },
        ...
        if (selection) {
          var _iterator2 = _createForOfIteratorHelper$k(Range.points(selection)),
              _step2;
    ...
    case 'merge_node':
      {
        ...
        if (!_node2) {
          return editor.onError({
            ...
            message: "Cannot apply a \"merge_node\" operation at path [".concat(_path2, "] because it could not be found."),
            data: {
              path: _path2,
              selection: selection
            },
        ...
        if (!prevPath) {
          return editor.onError({
            ...
            message: "Cannot apply a \"merge_node\" operation at path [".concat(_path2, "] because it has no previous sibling."),
            data: {
              path: _path2,
              selection: selection
            },
        ...
        if (!prev) {
          return editor.onError({
            ...
            message: "Cannot apply a \"merge_node\" operation at path [".concat(_path2, "] because its previous sibling could not be found."),
            data: {
              path: _path2,
              selection: selection
            },
        ...
        if (!_parent) {
          return editor.onError({
            ...
            message: "Cannot apply a \"merge_node\" operation at path [".concat(_path2, "] because it has no parent."),
            data: {
              path: _path2,
              selection: selection
            },
        ...
        if (Text.isText(_node2) && Text.isText(prev)) {
          ...
          return editor.onError({
            ...
            message: "Cannot apply a \"merge_node\" operation at path [".concat(_path2, "] to nodes of different interfaces: ").concat(Scrubber.stringify(_node2), " ").concat(Scrubber.stringify(prev)),
            data: {
              path: _path2,
              node: _node2,
              prev: prev,
        ...
        if (selection) {
          var _iterator3 = _createForOfIteratorHelper$k(Range.points(selection)),
              _step3;
    ...
    case 'move_node':
      {
        ...
        if (Path.isAncestor(_path3, newPath)) {
          return editor.onError({
            ...
            message: "Cannot move a path [".concat(_path3, "] to new path [").concat(newPath, "] because the destination is inside itself."),
            data: {
              path: _path3,
              newPath: newPath,
              selection: selection
        ...
        if (!_node3) {
          return editor.onError({
            ...
            message: "Cannot apply a \"move_node\" operation at path [".concat(_path3, "] because it could not be found."),
            data: {
              path: _path3,
              newPath: newPath,
              selection: selection
        ...
        if (!_parent2) {
          return editor.onError({
            ...
            message: "Cannot apply a \"move_node\" operation at path [".concat(_path3, "] because it has no parent."),
            data: {
              path: _path3,
              newPath: newPath,
              selection: selection
        ...
        var newParentPath = Path.parent(truePath);
        ...
        var newParent = Node.get(editor, newParentPath);
        var newIndex = truePath[truePath.length - 1];
        newParent.children.splice(newIndex, 0, _node3);

        if (selection) {
          var _iterator4 = _createForOfIteratorHelper$k(Range.points(selection)),
              _step4;
    ...
    case 'remove_node':
      {
        ...
        if (!_parent3) {
          return editor.onError({
            ...
            message: "Cannot apply a \"remove_node\" operation at path [".concat(_path4, "] because it has no parent."),
            data: {
              path: _path4,
              selection: selection
            },
        ...
        if (selection) {
          var _iterator5 = _createForOfIteratorHelper$k(Range.points(selection)),
              _step5;
          ...
          try {
            for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
              ...
              if (selection != null && result != null) {
                ...
                var _iterator6 = _createForOfIteratorHelper$k(Node.texts(editor)),
                    _step6;
    ...
    case 'remove_text':
      {
        ...
        if (!_node4) {
          return editor.onError({
            ...
            message: "Cannot apply a \"remove_text\" operation at path [".concat(_path5, "] because it could not be found."),
            data: {
              path: _path5,
              offset: _offset,
              text: _text,
        ...
        if (selection) {
          var _iterator7 = _createForOfIteratorHelper$k(Range.points(selection)),
              _step7;
    ...
    case 'set_node':
      {
        ...
        if (!_node5) {
          return editor.onError({
            ...
            message: "Cannot apply a \"set_node\" operation at path [".concat(_path6, "] because it could not be found."),
            data: {
              path: _path6,
              properties: properties,
              newProperties: newProperties,
        ...
        for (var _key6 in newProperties) {
          if (_key6 === 'children' || _key6 === 'text') {
            return editor.onError({
              ...
              message: "Cannot set the \"".concat(_key6, "\" property of nodes!"),
              data: {
                key: _key6,
                path: _path6,
                properties: properties,
          ...
          if (selection == null) {
            if (!Range.isRange(_newProperties)) {
              return editor.onError({
                ...
                message: "Cannot apply an incomplete \"set_selection\" operation properties ".concat(Scrubber.stringify(_newProperties), " when there is no current selection."),
                data: {
            ...
            selection = _objectSpread$c({}, _newProperties);
          }
            ...
            if (_value == null) {
              if (_key8 === 'anchor' || _key8 === 'focus') {
                return editor.onError({
                  ...
                  message: "Cannot remove the \"".concat(_key8, "\" selection property"),
                  data: {
                    key: _key8,
                    newProperties: _newProperties
                  },
    ...
    case 'split_node':
      {
        ...
        if (_path7.length === 0) {
          return editor.onError({
            ...
            message: "Cannot apply a \"split_node\" operation at path [".concat(_path7, "] because the root node cannot be split."),
            data: {
              path: _path7,
              position: position,
        ...
        if (!_node6) {
          return editor.onError({
            ...
            message: "Cannot apply a \"split_node\" operation at path [".concat(_path7, "] because it could not be found."),
            data: {
              path: _path7,
              position: position,
              properties: _properties,
        ...
        if (!_parent4) {
          return editor.onError({
            ...
            message: "Cannot apply a \"split_node\" operation at path [".concat(_path7, "] because it has no parent."),
            data: {
              path: _path7,
              position: position,
              properties: _properties,
        ...
        if (Text.isText(_node6)) {
          ...
          newNode = _objectSpread$c(_objectSpread$c({}, _properties), {}, {
            text: _after2
          });
        } else {
        ...
        if (selection) {
          var _iterator8 = _createForOfIteratorHelper$k(Range.points(selection)),
              _step8;
...
var SlateErrors = {
  EditorNext: function EditorNext() {
    return {
      type: 'EditorNext',
      message: "Cannot get the next node from the root node!"
    };
  },
  EditorPoint: function EditorPoint(edge, at) {
    return {
      type: 'EditorPoint',
      message: "Cannot get the ".concat(edge, " point in the node at path [").concat(at, "] because it has no ").concat(edge, " text node.")
    };
  },
  EditorPrevious: function EditorPrevious() {
    return {
      type: 'EditorPrevious',
      message: "Cannot get the previous node from the root node!"
    };
  },
  NodeAncestor: function NodeAncestor(node, path) {
    return {
      type: 'NodeAncestor',
      message: "Cannot get the ancestor node at path [".concat(path, "] because it refers to a text node instead: ").concat(Scrubber.stringify(node))
    };
  },
  NodeChildText: function NodeChildText(root) {
    return {
      type: 'NodeChildText',
      message: "Cannot get the child of a text node: ".concat(Scrubber.stringify(root))
    };
  },
  NodeChildIndex: function NodeChildIndex(root, index) {
    return {
      type: 'NodeChildIndex',
      message: "Cannot get child at index `".concat(index, "` in node: ").concat(Scrubber.stringify(root))
    };
  },
  NodeDescendant: function NodeDescendant(node, path) {
    return {
      type: 'NodeDescendant',
      message: "Cannot get the descendant node at path [".concat(path, "] because it refers to the root editor node instead: ").concat(Scrubber.stringify(node))
    };
  },
  NodeFragment: function NodeFragment(root) {
    return {
      type: 'NodeFragment',
      message: "Cannot get a fragment starting from a root text node: ".concat(Scrubber.stringify(root))
    };
  },
  NodeGet: function NodeGet(root, path) {
    return {
      type: 'NodeGet',
      message: "Cannot find a descendant at path [".concat(path, "] in node: ").concat(Scrubber.stringify(root))
    };
  },
  NodeLeaf: function NodeLeaf(node, path) {
    return {
      type: 'NodeLeaf',
      message: "Cannot get the leaf node at path [".concat(path, "] because it refers to a non-leaf node: ").concat(Scrubber.stringify(node))
    };
  },
  NodeParent: function NodeParent(path) {
    return {
      type: 'NodeParent',
      message: "Cannot get the parent of path [".concat(path, "] because it does not exist in the root.")
    };
  },
  PathNext: function PathNext(path) {
    return {
      type: 'PathNext',
      message: "Cannot get the next path of a root path [".concat(path, "], because it has no next index.")
    };
  },
  PathParent: function PathParent(path) {
    return {
      type: 'PathParent',
      message: "Cannot get the parent path of the root path [".concat(path, "].")
    };
  },
  PathPrevious: function PathPrevious(path) {
    return {
      type: 'PathPrevious',
      message: "Cannot get the previous path of a root path [".concat(path, "], because it has no previous index.")
    };
  },
  PathPreviousChild: function PathPreviousChild(path) {
    return {
      type: 'PathPreviousChild',
      message: "Cannot get the previous path of a first child path [".concat(path, "] because it would result in a negative index.")
    };
  },
  PathRelative: function PathRelative(path, ancestor) {
    return {
      type: 'PathRelative',
      message: "Cannot get the relative path of [".concat(path, "] inside ancestor [").concat(ancestor, "], because it is not above or equal to the path.")
    };
  },
  TransformsSelect: function TransformsSelect(target) {
    return {
      type: 'TransformsSelect',
      message: "When setting the selection and the current selection is `null` you must provide at least an `anchor` and `focus`, but you passed: ".concat(Scrubber.stringify(target))
    };
  }
};
    ...
    case 'merge_node':
      {
        ...
        if (!previousPath) {
          return editor.onError({
            ...
            message: "Cannot get the dirty paths after merging at path [".concat(_path2, "], because it has no previous path."),
            error: SlateErrors.PathPrevious(_path2),
            data: {
              path: _path2,
              ancestors: ancestors
            },
            recovery: _toConsumableArray(ancestors)
          });
        }
    ...
    case 'split_node':
      {
        ...
        if (!nextPath) {
          return editor.onError({
            ...
            message: "Cannot get the dirty paths after splitting at path [".concat(_path5, "], because it has no next path."),
            error: SlateErrors.PathNext(_path5),
            data: {
              path: _path5,
              levels: _levels
            },
            recovery: _toConsumableArray(_levels)
          });
        }
...
var normalizeNode = function normalizeNode(editor, entry) {
  ...
  for (var i = 0; i < node.children.length; i++, n++) {
    ...
    if (!currentNode) {
      var err = editor.onError({
        key: 'normalizeNode.get',
        message: "Cannot get the node at path [".concat(path, "] while normalizing."),
        data: {
          path: path
        },
...
var onError = function onError(editor, context) {
...
var shouldNormalize = function shouldNormalize(editor, _ref) {
  ...
  if (iteration > maxIterations) {
    return editor.onError({
      key: 'shouldNormalize',
      message: "Could not completely normalize the editor after ".concat(maxIterations, " iterations! This is usually due to incorrect normalization logic that leaves a node in an invalid state."),
      data: {
        iteration: iteration,
...
var above = function above(editor) {
  ...
  if (!path) {
    return editor.onError({
      key: 'above',
      message: 'Cannot get the node above a void node at the root of the document',
      data: {
        at: at
      }
    });
...
var addMark = function addMark(editor, key, value) {
  ...
  if (selection) {
    var match = function match(node, path) {
      ...
      var _parentEntry = _slicedToArray(parentEntry, 1),
          parentNode = _parentEntry[0];
    ...
    if (!expandedSelection) {
      var selectedEntry = Editor.node(editor, selection);
      ...
      var _selectedEntry = _slicedToArray(selectedEntry, 2),
          selectedNode = _selectedEntry[0],
          selectedPath = _selectedEntry[1];

      if (selectedNode && match(selectedNode, selectedPath)) {
        var parentEntry = Editor.parent(editor, selectedPath);
        ...
        var _parentEntry2 = _slicedToArray(parentEntry, 1),
            parentNode = _parentEntry2[0];
...
var marks = function marks(editor) {
  ...
  var entry = Editor.leaf(editor, path);
...
var next = function next(editor) {
  ...
  var toEntry = Editor.last(editor, []);
  ...
  var _toEntry = _slicedToArray(toEntry, 2),
      to = _toEntry[1];
  ...
  if (match == null) {
    if (Path.isPath(at)) {
      var parentEntry = Editor.parent(editor, at);
        ...
        if (Node.has(editor, _dirtyPath)) {
          ...
          if (!_entry) {
            editor.onError({
              ...
              message: 'Cannot get the node',
              data: {
                dirtyPath: _dirtyPath
              }
            });
            continue;
          }

          var _entry2 = _slicedToArray(_entry, 1),
              node = _entry2[0];
          /*
...
var path = function path(editor, at) {
  ...
  if (Path.isPath(at)) {
    if (edge === 'start') {
      var firstEntry = Node.first(editor, at);
      ...
      var _firstEntry = _slicedToArray(firstEntry, 2),
          firstPath = _firstEntry[1];

      at = firstPath;
    } else if (edge === 'end') {
      var lastEntry = Node.last(editor, at);
      ...
      var _lastEntry = _slicedToArray(lastEntry, 2),
          lastPath = _lastEntry[1];
...
var previous = function previous(editor) {
  ...
  var firstEntry = Editor.first(editor, []);
  ...
  var _firstEntry = _slicedToArray(firstEntry, 2),
      to = _firstEntry[1]; // The search location is from the start of the document to the path of
...
var removeMark = function removeMark(editor, key) {
  ...
  if (selection) {
    var match = function match(node, path) {
      ...
      var parentPath = Editor.parent(editor, path);
      ...
      var _parentPath = _slicedToArray(parentPath, 1),
          parentNode = _parentPath[0];
    ...
    if (!expandedSelection) {
      var entry = Editor.node(editor, selection);
      ...
      var _entry = _slicedToArray(entry, 2),
          selectedNode = _entry[0],
          selectedPath = _entry[1];
    ...
    for (var _i = 0, _pathRefs = pathRefs; _i < _pathRefs.length; _i++) {
      ...
      if (!path) {
        editor.onError({
          ...
          message: "Cannot lift nodes at a path [".concat(path, "] because it could not be unref'd."),
          data: {
            path: path
          }
        });
      ...
      if (path.length < 2) {
        editor.onError({
          key: 'liftNodes.depth',
          message: "Cannot lift node at a path [".concat(path, "] because it has a depth of less than `2`."),
          data: {
            path: path
          }
        });
      ...
      if (!parentPath) {
        return editor.onError({
          ...
          message: "Cannot lift node at a path [".concat(path, "] because it has no parent path."),
          data: {
            path: path
          }
        });
      ...
      var parentNodeEntry = Editor.node(editor, parentPath);

      var _parentNodeEntry = _slicedToArray(parentNodeEntry, 1),
      ...
      if (length === 1) {
        ...
        if (!toPath) {
          return editor.onError({
            key: 'liftNodes.next',
            message: "Cannot lift node at a path [".concat(path, "] because it has no next path."),
            data: {
              path: path,
  ...
  Editor.withoutNormalizing(editor, function () {
    ...
    if (Text.isText(node) && Text.isText(prevNode)) {
      ...
      editor.onError({
        ...
        message: "Cannot merge the node at path [".concat(path, "] with the previous sibling because it is not the same kind: ").concat(Scrubber.stringify(node), " ").concat(Scrubber.stringify(prevNode)),
        data: {
          path: path,
          node: node,
          prevNode: prevNode
  ...
  Editor.withoutNormalizing(editor, function () {
    ...
    for (var _i = 0, _pathRefs = pathRefs; _i < _pathRefs.length; _i++) {
      ...
      if (toRef.current && Path.isSibling(newPath, path) && Path.isAfter(newPath, path)) {
        ...
        var nextPath = Path.next(toRef.current);

        if (!nextPath) {
          editor.onError({
            key: 'moveNodes.next',
            message: "Cannot move nodes to a path [".concat(toRef.current, "] because it has no next path."),
            data: {
              toRef: toRef
            }
          });
      ...
      if (path) {
        ...
        if (!entry) {
          editor.onError({
            ...
            message: "Cannot remove node at path [".concat(path, "] because it could not be found."),
            data: {
              path: path
            }
          });
...
var setNodes = function setNodes(editor, props) {
  ...
  Editor.withoutNormalizing(editor, function () {
    ...
    if (split && Range.isRange(at)) {
      var leaf = Editor.leaf(editor, at.anchor);
    ...
    var _iterator = _createForOfIteratorHelper$5(Editor.nodes(editor, {
      at: at,
      match: match,
      mode: mode,
      voids: voids
...
var splitNodes = function splitNodes(editor) {
  ...
  Editor.withoutNormalizing(editor, function () {
    ...
    if (Path.isPath(at)) {
      ...
      if (!point) {
        editor.onError({
          ...
          message: "Cannot find point at path ".concat(Scrubber.stringify(path)),
          data: {
            path: path
          }
        });
      ...
      if (!parentEntry) {
        editor.onError({
          ...
          message: "Cannot find parent node at path ".concat(Scrubber.stringify(path)),
          data: {
            path: path
          }
        });
    ...
    try {
        ...
        if (Element.isElement(voidNode) && editor.isInline(voidNode)) {
          ...
          if (!after) {
            ...
            if (!afterPath) {
              editor.onError({
                key: 'splitNodes.next',
                message: "Cannot find next path after ".concat(Scrubber.stringify(voidPath)),
                data: {
                  path: voidPath
                }
              });
      ...
      var _iterator = _createForOfIteratorHelper$4(Editor.levels(editor, {
        at: lowestPath,
        reverse: true,
        voids: voids
      })),
...
var unsetNodes = function unsetNodes(editor, props) {
  ...
  var _iterator = _createForOfIteratorHelper$3(props),
      _step;
...
var unwrapNodes = function unwrapNodes(editor) {
  ...
  Editor.withoutNormalizing(editor, function () {
    ...
    if (Path.isPath(at)) {
      ...
      if (!range) {
        editor.onError({
          ...
          message: "Cannot unwrap nodes at path [".concat(at, "] because it could not be found."),
          data: {
            path: at
          }
        });
    ...
    var _iterator = _createForOfIteratorHelper$2(pathRefs),
        _step;
      ...
      var _loop = function _loop() {
        ...
        if (!entry) {
          editor.onError({
            ...
            message: "Cannot unwrap node at path [".concat(path, "] because it could not be found."),
            data: {
              path: path
            }
          });
        ...
        if (!range) {
          editor.onError({
            key: 'unwrapNodes.range',
            message: "Cannot unwrap nodes at path [".concat(path, "] because it could not be found."),
            data: {
              path: path
            }
          });
...
var wrapNodes = function wrapNodes(editor, element) {
  ...
  Editor.withoutNormalizing(editor, function () {
    ...
    for (var _i = 0, _roots = roots; _i < _roots.length; _i++) {
      ...
      var range = Editor.range(editor, rootPath);
      ...
      var a = Range.isRange(at) ? Range.intersection(at, range) : at;
      ...
      if (matches.length > 0) {
        var _ret = function () {
          ...
          var wrapper = _objectSpread$1(_objectSpread$1({}, element), {}, {
            children: []
          });
...
var select = function select(editor, target) {
  var selection = editor.selection;
  var range = Editor.range(editor, target);

  if (!range) {
    editor.onError({
      key: 'select.range.1',
      message: "Cannot select a non-existent range: ".concat(Scrubber.stringify(target)),
      data: {
        target: target
      }
    });
...
var setPoint = function setPoint(editor, props) {
  ...
  Transforms.setSelection(editor, _defineProperty({}, edge === 'anchor' ? 'anchor' : 'focus', _objectSpread(_objectSpread({}, point), props)));
};
...
var deleteText = function deleteText(editor) {
  ...
  Editor.withoutNormalizing(editor, function () {
    ...
    var _iterator = _createForOfIteratorHelper$1(Editor.nodes(editor, {
      at: at,
      voids: voids
    })),
        _step;
    ...
    if (!isSingleText && !startNonEditable) {
      ...
      var entry = Editor.leaf(editor, _point);

      if (!entry) {
        editor.onError({
          key: 'deleteText.leaf',
          message: "Cannot find leaf node at path [".concat(_point.path, "]."),
          data: {
            at: at
          }
        });
    ...
    if (!endNonEditable) {
      ...
      var _entry2 = Editor.leaf(editor, _point2);

      if (!_entry2) {
        editor.onError({
          key: 'deleteText.leaf',
          message: "Cannot find leaf node at path [".concat(_point2.path, "]."),
          data: {
            at: at
          }
        });
      ...
      var _entry3 = _slicedToArray(_entry2, 1),
          _node = _entry3[0];
...
var insertFragment = function insertFragment(editor, fragment) {
  ...
  Editor.withoutNormalizing(editor, function () {
    ...
    if (Range.isRange(at)) {
      ...
      var _at = Editor.start(editor, at);

      if (!_at) {
        editor.onError({
          key: 'insertFragment.start',
          message: "Cannot find start point to insert fragment at path [".concat(at, "]."),
          data: {
            at: at,
            fragment: fragment
          }
      ...
      if (Editor.isEnd(editor, at, _inlinePath)) {
        ...
        if (!at) {
          editor.onError({
            ...
            message: "Cannot find end point to insert fragment after inline at path [".concat(_inlinePath, "]."),
            data: {
              at: at,
              fragment: fragment
            }
        ...
        if (!at) {
          editor.onError({
            ...
            message: "Cannot find start point to insert fragment before inline at path [".concat(_inlinePath, "]."),
            data: {
              at: at,
              fragment: fragment
            }
    ...
    if (!firstEntry) {
      editor.onError({
        ...
        message: "Cannot find first point to insert fragment at path [".concat(at, "]."),
        data: {
          at: at,
          fragment: fragment
        }
    ...
    if (!lastEntry) {
      editor.onError({
        ...
        message: "Cannot find last point to insert fragment at path [".concat(at, "]."),
        data: {
          at: at,
          fragment: fragment
        }
    ...
    var matcher = function matcher(_ref) {
      ...
      return !(mergeEnd && Path.isAncestor(p, lastPath) && Element.isElement(n) && !editor.isVoid(n) && !editor.isInline(n));
    };
    ...
    var middlePath = isBlockEnd && !ends.length ? Path.next(blockPath) : blockPath;

    if (!middlePath) {
      editor.onError({
        key: 'insertFragment.middlePath',
        message: "Cannot find middle point to insert fragment at path [".concat(at, "]."),
        data: {
          at: at,
          fragment: fragment
        }
    ...
    var middleRef = Editor.pathRef(editor, middlePath);
    var endPath = isInlineEnd ? Path.next(inlinePath) : inlinePath;

    if (!endPath) {
      editor.onError({
        key: 'insertFragment.endPath',
        message: "Cannot find end point to insert fragment at path [".concat(at, "]."),
        data: {
          at: at,
          fragment: fragment
        }
    ...
    var endRef = Editor.pathRef(editor, endPath);
    Transforms.splitNodes(editor, {
      at: at,
      match: function match(n) {
    ...
    var startPath = !isInlineStart || isInlineStart && isInlineEnd ? Path.next(inlinePath) : inlinePath;
    ...
    var startRef = Editor.pathRef(editor, startPath);
...
var createEditor = function createEditor() {
  var editor = {
    ...
    onError: function onError$1() {
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      return onError.apply(void 0, [editor].concat(args));
    },
    // Core
