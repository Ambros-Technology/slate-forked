...
var addMark = (editor, key, value) => {
  ...
  if (selection) {
    ...
    if (!expandedSelection) {
      ...
      var [selectedNode, selectedPath] = selectedEntry;
...
var previous = function previous(editor) {
  ...
  var [, to] = firstEntry; // The search location is from the start of the document to the path of
...
var removeMark = (editor, key) => {
  ...
  if (selection) {
    ...
    if (!expandedSelection) {
      ...
      var [selectedNode, selectedPath] = entry;
...
var setPoint = function setPoint(editor, props) {
  ...
  Transforms.setSelection(editor, {
    [edge === 'anchor' ? 'anchor' : 'focus']: _objectSpread(_objectSpread({}, point), props)
  });
};
...
var deleteText = function deleteText(editor) {
  ...
  Editor.withoutNormalizing(editor, () => {
    ...
    if (!isSingleText && !startNonEditable) {
      ...
      var _entry = Editor.leaf(editor, _point);
